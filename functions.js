...
function addHistory(question) {
  ...
  entry.prepend(document.createTextNode(question))
  history.prepend(entry)
  // set scroll bar to bottom so most recent question appears
...
var easyQuestions = [
  ...
  "Have you bought something you didn't need but bought it because it was on sale?",
  "What TV show did you grow up watching when you were a kid?",
  "When shopping, you see an item you like but don't need, do you wait for it to go on sale or do you buy it on the spot?",
  "What is your favorite class/subject in school?",
  "What is a skillset you are really good at doing?",
  "What is a skillset you are really bad at doing?",
]
